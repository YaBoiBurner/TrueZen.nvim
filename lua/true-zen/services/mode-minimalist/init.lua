...
local function toggle()
	...
	elseif (minimalist_show == nil) then
		...
		if ((left.left_show == nil) and (bottom.bottom_show == nil) and (top.top_show == nil)) then
			...
			minimalist_show = 0
			minimalist_false()
		elseif ((left.left_show == 1) and (bottom.bottom_show == 1) and (top.top_show == true)) then
			-- cmd("echo 'FOUR'")
			minimalist_show = 1
			minimalist_false()
		elseif ((left.left_show == 0) and (bottom.bottom_show == 0) and (top.top_show == false)) then
			-- cmd("echo 'FIVE'")
			minimalist_show = 0
			minimalist_true()
